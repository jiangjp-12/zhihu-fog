...
/* ============ 备用话题池 ============
   每个圈子多备 2 条，配合 fetchHotPost 的随机选取与「不与上一局重复」，
   即使没有真实热榜也不会每局都看到同一个帖子。 */
const EXTRA_TOPICS = {
  tech: [
    { title:'手机厂商集体取消充电器，环保是真的还是借口？',
      body:'包装盒薄了一半，说是减少电子垃圾。可我抽屉里的旧充电器功率对不上，最后还是又买了一个。到底谁省了成本？',
      hot:[{n:'拆机十年',t:'环保省的是运费，你省的是啥？'},
           {n:'快充协议党',t:'协议一家一个样，通用充电器就是个笑话。'},
           {n:'抽屉考古学家',t:'我七个充电头，没一个能给新机满速。'}] },
    { title:'为什么很多人用了几天就把智能手表卖了？',
      body:'买之前想着记录睡眠、提醒站起来、监测心率。用了一周发现每天最大的仪式是给它充电。',
      hot:[{n:'戒断成功',t:'它提醒我站起来，我提醒自己别买。'},
           {n:'跑步真用户',t:'真跑步的人离不开，不跑的人图个新鲜。'},
           {n:'充电线管理员',t:'多一个要充电的东西，就多一份焦虑。'}] },
  ],
  emo: [
    { title:'两个人在一起三年，聊天记录越来越短，正常吗？',
      body:'从前一天几百条，现在剩「到了」「吃了」「睡吧」。也没吵架，就是没什么可说的了。',
      hot:[{n:'老夫老妻',t:'话少不等于情少，但你介意就是问题。'},
           {n:'刚分手',t:'我们最后半年也这样，别骗自己。'},
           {n:'心理系旁听',t:'你在意的是话变少，还是他变了？'}] },
    { title:'父母突然对你很客气，是种什么信号？',
      body:'以前催婚催工作，现在说话小心翼翼，问一句还怕打扰我。这种客气让我更难受。',
      hot:[{n:'三十岁儿子',t:'他们开始怕你了，这才是真的老了。'},
           {n:'远嫁',t:'客气是距离的另一种说法。'},
           {n:'陪护半年',t:'趁还能听他们唠叨，别嫌烦。'}] },
  ],
  work: [
    { title:'为什么开会越多的公司，效率反而越低？',
      body:'一天四个会，每个会都在同步进度。真正干活的时间被切成碎片，最后靠加班补。',
      hot:[{n:'项目管理',t:'会开多了说明没人敢担责。'},
           {n:'研发五年',t:'同步会的本质是领导不看文档。'},
           {n:'日历爆满',t:'我的产出发生在所有人下班之后。'}] },
    { title:'裸辞三个月还没找到工作，是我的问题吗？',
      body:'走的时候觉得凭本事到哪都行。三个月过去，投的简历大半没回，开始怀疑自己。',
      hot:[{n:'HR视角',t:'空窗期不致命，讲不清为什么走才致命。'},
           {n:'裸辞两次',t:'不是你的问题，但也不全是环境的问题。'},
           {n:'去年上岸',t:'先找个能过渡的，别在家里等状态回来。'}] },
  ],
  campus: [
    { title:'大学社团到底值不值得花时间？',
      body:'进了三个社团，一年下来除了几张合照和一堆群消息，好像什么也没留下。',
      hot:[{n:'退了三个',t:'值不值看你在里面做事还是凑数。'},
           {n:'社长本人',t:'办活动学到的东西，课堂真的教不了。'},
           {n:'大四回望',t:'留下来的是人，不是经历。'}] },
    { title:'考研二战值得吗？',
      body:'一战差十分。家里说再来一年也行，但看着同学入职发工资，心里越来越慌。',
      hot:[{n:'二战上岸',t:'差十分说明方法有问题，不是时间不够。'},
           {n:'放弃了',t:'我去工作了，现在也没后悔。'},
           {n:'三战劝退',t:'先想清楚读研要干什么，再决定。'}] },
  ],
  law: [
    { title:'租房押金不退，除了忍还能怎么办？',
      body:'退租时房东说墙有污渍、地板有划痕，两千押金一分不退。合同里没写这些标准。',
      hot:[{n:'执业五年',t:'没约定标准，举证责任在房东。'},
           {n:'追回过',t:'先要书面扣款明细，他多半不敢给。'},
           {n:'调解见过',t:'两千块走小额诉讼，成本比你想的低。'}] },
    { title:'公司要求签「自愿放弃社保」，签了有效吗？',
      body:'入职时 HR 拿出一份声明，说签了工资能多几百。旁边同事都签了。',
      hot:[{n:'劳动法方向',t:'签了也无效，社保是法定义务。'},
           {n:'仲裁赢过',t:'那几百块是拿你的未来换的。'},
           {n:'HR不这么干',t:'敢让你签这个的公司，还有别的雷。'}] },
  ],
};

/** 某圈子的完整话题池：主话题 + 备用 */
function topicPool(circle) {
  const main = MOCK_POSTS[circle] || MOCK_POSTS.tech;
  return [main, ...(EXTRA_TOPICS[circle] || [])];
}
